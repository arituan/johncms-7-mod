...
$menu = [
    ...
    ($mod == 'thank' ? '<b>Thanks</b>' : '<a href="index.php?act=top&amp;mod=thank">Thanks</a>'),
];
...
switch ($mod) {
   ...
   case 'thank':
        // Топ комментариев
        echo '<div class="phdr"><a href="index.php"><b>' . _t('Community') . '</b></a> | ' . _t('Most thanked') . '</div>';
        echo '<div class="topmenu">' . implode(' | ', $menu) . '</div>';
        echo get_top('postthank');
        echo '<div class="phdr"><a href="../index.php">' . _t('Home') . '</a></div>';
        break;
    case 'karma':
        // Топ Кармы

...
text-decoration: none;
            ...
            <a href="javascript:tag(\'[img=\', \']\')"><img style="border: 0;" src="' . $this->homeUrl . '/images/bb/img.gif" alt="quote" title="' . _t('Image', 'system') . '" /></a>
    ...
    private function highlightBb($var)
    {
        ...
        $replace = [
            ...
            '<img src="$1" style="width:100%; max-width:600px;" />' //image

 ...
 * @license     GPL-3
 */
/* mod by gocmaster.com (AriTuan) */

const JOHNCMS = '7.0.0 edition v1';
...
if (isset($_POST['lng']) && ($_POST['lng'] == 'ru' || $_POST['lng'] == 'en' || $_POST['lng'] == 'vi')) {
...
if (!$act) {
    echo '<form action="index.php" method="post">' .
        ...
        '<div><input type="radio" name="lng" value="vi" ' . ($language == 'vi' ? 'checked="checked"' : '') . ' />&#160;Việt Nam</div>' .
    ...
    case 'set':
        ...
        if ($db_check && isset($_POST['install'])) {
            ...
            if ($db_check && empty($site_error) && empty($admin_error)) {
                ...
                setcookie("cussid", $ssid, time() + 3600 * 24 * 365);
...
echo '<hr />&copy;&#160;Powered by <a href="http://johncms.com">JohnCMS</a> & edited by <a href="http://gocmaster.com">Gocmaster</a></body></html>';

...
ALTER TABLE `users` ADD `postthank` INT(10) UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `users` ADD `ssid` VARCHAR(60) NOT NULL DEFAULT '',
ALTER TABLE `library_texts` CHANGE `count_comments` `comm_count` INT(11) UNSIGNED NOT NULL DEFAULT '0';


--
-- Create table `cms_forum_thank`
--
DROP TABLE IF EXISTS `cms_forum_thank`;
CREATE TABLE `cms_forum_thank` (
  `user_id` int(11) UNSIGNED NOT NULL default '0',
  `fid` int(11) UNSIGNED NOT NULL,
  `time` int(10) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY  (`user`, `fid`)
)
  ENGINE=MyISAM
...
ALTER TABLE `cms_mail` ADD `sys_ext`   INT(10) UNSIGNED NOT NULL DEFAULT '0';
--
...
ALTER TABLE `users` CHANGE `password` `password` VARCHAR(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '';
